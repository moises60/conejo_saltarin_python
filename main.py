...
# Cargar imágenes
imagen_conejo_1 = cargar_imagen("conejo.png", ancho=50, alto=50)
imagen_conejo_2 = cargar_imagen("conejo2.png", ancho=50, alto=50)
imagen_fondo = cargar_imagen("fondo.png", ancho=ancho_pantalla, alto=alto_pantalla)
